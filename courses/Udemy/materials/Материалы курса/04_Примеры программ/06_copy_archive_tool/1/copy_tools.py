...
def change_name_if_exists(dst_file_name, is_file=True):
        destination, name = dst_file_name.rsplit(os.path.sep, maxsplit=1)
        ...
        while os.path.exists(dst_file_name):
            ...
            dst_file_name = os.path.join(destination, new_name)
            count +=1
