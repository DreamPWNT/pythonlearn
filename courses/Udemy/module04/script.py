...
print(x)
print(list(range(50, -11, -2)))
print(list(range(-1, -52, -2)))
print(tuple(range(-1, -52, -2)))

print(x.count(6))
print(x.index(10))
print(range(45).start)

for i in range(10):
    print(i)

for i in range(len(cur.currencies)):
    value = cur.currencies[i]

    print(value)

for i in range(len(cur.currencies)-1, -1, -1):
    if cur.currencies[i][0] == 'PHP':
        cur.currencies.pop(i)
